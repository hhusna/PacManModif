...
public class PacManModif extends JPanel implements ActionListener, KeyListener {
    class Block {
        int x;
        int y;
        int width;
    ...
    private int boardHeight = (rowCount * tileSize) + scoreHeight;
    ...
    public void draw(Graphics g) {
        ...
        //dihapus karena sudah ada deklarasi khusus untuk panel score dan lives
        /*if (gameOver) {
            g.drawString("Game Over: " + String.valueOf(score), tileSize/2, tileSize/2);
        }
        else {
            g.drawString("Score: " + score + "   Lives: " + lives, tileSize, scoreHeight - 10);
        }*/
    }
